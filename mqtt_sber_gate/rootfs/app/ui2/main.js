function Init(){
   ...
   AddBlok('<a href="data/devices.json" download="devices.json">Скачать devices.json</a></p>')
   AddBlok('<a href="data/categories.json" download="categories.json">Скачать categories.json</a></p>')
